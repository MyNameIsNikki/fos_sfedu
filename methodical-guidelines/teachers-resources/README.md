...
Данный раздел содержит рекомендации по подбору, подготовке и использованию информационных ресурсов для проведения лабораторных работ по дисциплине «Глубокое обучение для зрения».
